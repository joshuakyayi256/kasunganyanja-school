        ...
        <div>
            ...
            <div className="max-w-6xl mx-auto px-4 py-10 space-y-10">
                <div className="grid md:grid-cols-2 gap-6">
                    <Card>
                        <h4 className="font-semibold text-lg">Primary 1 – Primary 3</h4>
                        <ul className="mt-2 list-disc pl-5 text-black/85 space-y-1 text-lg">
                            {p1p3.map(s => <li key={s}>{s}</li>)}
                        </ul>
                    </Card>
                    <Card>
                        <h4 className="font-semibold text-lg">Primary 4 – Primary 7</h4>
                        <ul className="mt-2 list-disc pl-5 text-black/85 space-y-1 text-lg">
                ...
                <Card>
                    <h4 className="font-semibold text-lg">Co-curricular</h4>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <Card>
                        <h4 className="font-semibold text-lg">Support & Assessment</h4>
                    ...
                    <Card>
                        <h4 className="font-semibold text-lg">School Day</h4>
                        <p className="mt-2 text-black/80 text-lg">
